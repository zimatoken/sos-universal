...
const LOCALES = {
  ...
  ru: {
    ...
    support_sbp_hint: "Работает в любом банке РФ",
    support_tinkoff: "Т-Банк (Тинькофф)",
    support_tinkoff_hint: "Для клиентов Т-Банка",
    support_evm: "USDT / ETH (EVM)",
  ...
  en: {
    ...
    support_sbp_hint: "Works with any Russian bank",
    support_tinkoff: "T-Bank (Tinkoff)",
    support_tinkoff_hint: "For T-Bank clients",
    support_evm: "USDT / ETH (EVM)",
    support_evm_hint: "Ethereum, Base, Polygon, BNB, Arbitrum, OP",
    support_tron: "USDT TRC-20 (Tron)",
