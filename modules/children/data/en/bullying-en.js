...
const bullyingDataEn = {
  ...
  questions: [
    {
      ...
      options: [
        ...
        { id: "verbal", label: "??? Verbal abuse, insults, threats, blackmail", tags: ["verbal"] },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "witness", label: "??? I found out as a witness / from another child", tags: ["witness"] },
  ...
  solutions: [
    ...
    },
    {
      ...
      title: "?? My child is the aggressor. What to do?",
