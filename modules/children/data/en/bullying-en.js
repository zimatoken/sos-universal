// === MODULE: CHILDREN — BULLYING (EN) ===
const bullyingData = {
  category: "bullying",
  title: "💔 Bullying",
  description: "Physical violence, insults, cyberbullying, ostracism — how to protect your child",
  ...
  questions: [
    {
      ...
      type: "single",
      options: [
        { id: "physical", label: "Physical violence (pushing, hitting, taking things)", tags: ["physical"] },
        { id: "verbal", label: "Words, insults, threats, blackmail", tags: ["verbal"] },
        { id: "cyber", label: "Cyberbullying (social media, messengers, games)", tags: ["cyber"] },
        { id: "social", label: "Social ostracism (exclusion, gossip, boycott)", tags: ["social"] },
        { id: "sexual", label: "Sexual harassment / inappropriate comments", tags: ["sexual"] }
      ]
    },
    {
      id: "role",
      ...
      options: [
        ...
        { id: "witness", label: "I learned as a witness / from another child", tags: ["witness"] },
  ...
  solutions: [
    {
      ...
      title: "🥊 Physical violence — protection and actions",
      ...
      steps: [
        ...
        "If there are injuries — see a doctor, get a certificate. For serious injuries — emergency and police",
        ...
        "If the school ignores — file a police report (assault, bodily harm). Attach photos, certificates, records",
        "Contact the juvenile affairs commission. They can intervene regarding the aggressor's family",
        "Consider transferring to another class or school. Sometimes this is the only way to stop bullying. Do not consider it 'running away' — your child's safety comes first",
        "Enroll the child in martial arts (not for revenge, but for confidence). Psychologist, group therapy for bullying victims — restoring self-esteem",
        "Teach the child: shout 'Don't touch me!', run to a crowded place, call you immediately. Not 'be a man' — that's dangerous"
      ],
      warnings: [
        "DO NOT tell the child 'just deal with it yourself' — they already tried, it didn't work. This will worsen the trauma and close trust",
        "DO NOT go 'sort it out' with the aggressor or their parents yourself — it may end in a fight and criminal charges against you",
        "DO NOT ignore it as 'just kids'. Repeated physical violence is a crime. Document every incident",
        "If the child is afraid to go to school, cries in the morning, pretends to be sick — these are alarm signals. Act immediately"
      ]
    },
    {
      id: "cyberbullying",
      ...
      steps: [
        "Take screenshots of EVERYTHING: insults, threats, photos, videos, aggressor profiles. Save to cloud and computer. Do not delete chats before contacting police — this is the main evidence",
        "Block aggressors on all platforms. Enable 'friends only' mode on VK, Instagram, TikTok. Close comments",
        "If content is being spread (photos, videos, fakes) — contact platform support: VK, Telegram, TikTok, YouTube. Demand removal per community guidelines. State that the child is a minor",
        "If there are threats, blackmail, spreading intimate photos — immediately to police. Provide screenshots, chats, profiles",
      ...
      warnings: [
        "DO NOT take away the phone 'forever' as punishment — the child will lose connection with friends and their only support. Limit temporarily, explain why",
        "DO NOT say 'just turn off the phone' — for a teen, social media = social life. Ignoring doesn't solve the problem",
        "Spreading intimate photos of a minor is a criminal offense. Even if the child took the photo themselves — they are the victim, the aggressor is responsible",
        "DO NOT publish chats publicly on social media — it may escalate the situation and become a defamation charge against you"
      ]
    },
    {
      id: "verbal_social_bullying",
      title: "💬 Verbal and social ostracism",
      ...
      steps: [
        ...
        "Talk to the homeroom teacher. Ask for: seating change, group assignments (to break cliques), tolerance class. Do not name names publicly — it will escalate",
        "If bullying is systematic (entire class) — demand principal and school psychologist intervention. In extreme cases — transfer to another school. The child's psyche comes first",
        ...
        "Teach the child techniques: 'I don't accept this' (calmly, without shouting), leaving the situation, finding an adult. Not 'fight back' — that's escalation",
        "If insults turn into threats, defamation, public humiliation — document and consult a lawyer"
      ],
      warnings: [
        "DO NOT say 'just ignore it' — for a child, classmates = the whole world. Ignoring doesn't work with systematic bullying",
        ...
        "DO NOT publicly accuse other children in the parent chat — their parents will defend them, and your child will face retaliation",
        "Social bullying often accompanies cyberbullying. Check the child's phone — the bullying may continue online"
      ]
    },
    {
      ...
      steps: [
        ...
        "Set clear boundaries: 'Bullying others is unacceptable. It causes pain. There will be consequences'. But consequences are not beatings — loss of privileges, psychologist work",
        ...
        "Check the family: is there violence at home? Is an adult bullying someone? Children copy behavior models. If there are screams, hits at home — the child transfers this to school",
        "Work with the teacher, school psychologist. Ask for: monitoring, seating change, individual plan. Don't hide the problem — it will escalate",
        "If aggression is physical and serious — be prepared for responsibility. School, juvenile commission, police. But the main thing is not punishment, but behavior change through help"
      ],
      warnings: [
        "DO NOT defend the child with 'my child wouldn't' — this closes the problem and worsens behavior. Acknowledgment is the first step to help",
        "DO NOT hit the child for aggression — they will learn that force solves problems. Violence breeds violence",
