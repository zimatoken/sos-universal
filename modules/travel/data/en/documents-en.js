...
TRAVEL_DATA.documents = {
  ...
  questions: [
    {
      id: "doc_type",
      question: "Which document is lost or stolen?",
      options: [
        { value: "passport", label: "Passport" },
        { value: "visa", label: "Visa / Schengen" },
        { value: "tickets", label: "Tickets (flight / train / bus)" },
        { value: "insurance", label: "Insurance policy" },
        { value: "all", label: "Multiple documents at once" }
      ]
    },
    {
      id: "location",
      question: "Where did the loss occur?",
      options: [
        { value: "abroad", label: "Abroad (in another country)" },
        { value: "transit", label: "At airport / station / in transport" },
        { value: "hotel", label: "At hotel / rental accommodation" },
        { value: "street", label: "On the street / public place" },
        { value: "home", label: "At home (before departure)" }
      ]
    },
    {
      id: "copies",
      question: "Do you have copies of documents (photos on phone, scans)?",
      options: [
        { value: "yes", label: "Yes, photos/scans on phone or cloud" },
        { value: "no", label: "No, nothing" },
        { value: "partial", label: "Only partial (e.g. only passport photo)" }
      ]
    },
    {
      id: "time",
      question: "When did you discover the loss?",
      options: [
        { value: "urgent", label: "Right now / just now" },
        { value: "today", label: "Today, a few hours ago" },
  ...
  results: [
    {
      ...
      meta: { severity: "high", time: "1-5 days" }
    },
    {
      id: "passport_transit",
    ...
    },
    {
      ...
      meta: { severity: "high", time: "3-10 days" }
    },
    {
      id: "tickets_lost",
      title: "Lost tickets",
      ...
      meta: { severity: "low", time: "15-60 min" }
    },
    {
      id: "insurance_lost",
      ...
      meta: { severity: "low", time: "5-30 min" }
    },
    {
      id: "docs_no_copies",
      ...
      meta: { severity: "high", time: "5-10 days" }
    }
  ]
};
