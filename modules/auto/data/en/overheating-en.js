  ...
  questions: [
    {
      ...
      options: [
        ...
        { id: "warning_light", label: "⚠️ Overheat warning light came on", tags: ["warning"] },
        { id: "steam_radiator", label: "🌫️ Steam from radiator or expansion tank", tags: ["steam"] },
        { id: "loss_power", label: "🐢 Power loss, engine misfiring", tags: ["loss_power"] },
        { id: "coolant_leak", label: "💧 Puddle under the car (green/red fluid)", tags: ["leak"] },
